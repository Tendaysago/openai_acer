...
class Population(object):
    ...
    def __init__(self, config, initial_state=None):
        ...
        self.reproduction = config.reproduction_type(config.reproduction_config,
                                                     self.reporters,
                                                     stagnation)
        self.outpath = "{}_{}".format(config.reproduction_config.multi_optimization,datetime.datetime.now().strftime('%Y_%m_%d_%H_%M_%S'))
    ...
    def run(self, fitness_function, n=None):
        ...
        while n is None or k < n:
            ...
            self.reporters.end_generation(self.config, self.population, self.species, self.allhistory,self.outpath)
